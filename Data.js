...
const DB = {
  ...
  patient: [
    { id: 'pac-carlos',   tipo_identificacion: 'CC', numero_identificacion: '1037642891', nombre: 'Carlos Andrés', apellido: 'Martínez López', fecha_nacimiento: '1985-03-22', edad: 40, nacionalidad: 'Colombiana' },
    { id: 'pac-ana',      tipo_identificacion: 'CC', numero_identificacion: '43821675',   nombre: 'Ana',           apellido: 'Gómez Ruiz',      fecha_nacimiento: '1978-11-02', edad: 47, nacionalidad: 'Colombiana' },
    { id: 'pac-luis',     tipo_identificacion: 'CC', numero_identificacion: '71234509',   nombre: 'Luis',          apellido: 'Pérez Castro',    fecha_nacimiento: '1990-06-15', edad: 35, nacionalidad: 'Colombiana' },
    { id: 'pac-sofia',    tipo_identificacion: 'CC', numero_identificacion: '52198430',   nombre: 'Sofía',         apellido: 'Ramírez',          fecha_nacimiento: '1995-01-30', edad: 30, nacionalidad: 'Colombiana' },
    { id: 'pac-sandra',   tipo_identificacion: 'CC', numero_identificacion: '52001234',   nombre: 'Sandra',        apellido: 'Vélez',            fecha_nacimiento: '1982-09-12', edad: 43, nacionalidad: 'Colombiana' },
    { id: 'pac-maria',    tipo_identificacion: 'CC', numero_identificacion: '43001122',   nombre: 'María',         apellido: 'Ruiz',             fecha_nacimiento: '1975-04-05', edad: 50, nacionalidad: 'Colombiana' },
    { id: 'pac-jorge',    tipo_identificacion: 'CC', numero_identificacion: '79887766',   nombre: 'Jorge',         apellido: 'Castro',           fecha_nacimiento: '1988-08-20', edad: 37, nacionalidad: 'Colombiana' },
    { id: 'pac-patricia', tipo_identificacion: 'CC', numero_identificacion: '31556677',   nombre: 'Patricia',      apellido: 'Gil',              fecha_nacimiento: '1992-12-01', edad: 33, nacionalidad: 'Colombiana' },
  ],

  // ---- donor: Id, codigo_donante, fecha_extraccion, fecha_procedimiento, fecha_segundo_cambio, fecha_vencimiento ----
  donor: [
    { id: 'don-r3-26290', codigo_donante: 'R3 INML 26.290', fecha_extraccion: iso(-10), fecha_procedimiento: iso(-8), fecha_segundo_cambio: iso(-3), fecha_vencimiento: iso(20) },
    { id: 'don-26964',    codigo_donante: '26.964',          fecha_extraccion: iso(-12), fecha_procedimiento: iso(-11), fecha_segundo_cambio: iso(-6), fecha_vencimiento: iso(5) },
    { id: 'don-2025-018', codigo_donante: 'DON-2025-018',    fecha_extraccion: iso(-20), fecha_procedimiento: iso(-19), fecha_segundo_cambio: iso(-15), fecha_vencimiento: iso(-3) },
    { id: 'don-2025-011', codigo_donante: 'DON-2025-011',    fecha_extraccion: iso(-35), fecha_procedimiento: iso(-34), fecha_segundo_cambio: iso(-31), fecha_vencimiento: iso(-20) },
    { id: 'don-2025-004', codigo_donante: 'DON-2025-004',    fecha_extraccion: iso(-50), fecha_procedimiento: iso(-49), fecha_segundo_cambio: iso(-46), fecha_vencimiento: iso(-35) },
    { id: 'don-2025-006', codigo_donante: 'DON-2025-006',    fecha_extraccion: iso(-40), fecha_procedimiento: iso(-39), fecha_segundo_cambio: iso(-36), fecha_vencimiento: iso(-25) },
    { id: 'don-2025-001', codigo_donante: 'DON-2025-001',    fecha_extraccion: iso(-15), fecha_procedimiento: iso(-14), fecha_segundo_cambio: iso(-11), fecha_vencimiento: iso(25) },
    { id: 'don-2025-003', codigo_donante: 'DON-2025-003',    fecha_extraccion: iso(-14), fecha_procedimiento: iso(-13), fecha_segundo_cambio: iso(-10), fecha_vencimiento: iso(26) },
    { id: 'don-2025-009', codigo_donante: 'DON-2025-009',    fecha_extraccion: iso(-45), fecha_procedimiento: iso(-44), fecha_segundo_cambio: iso(-41), fecha_vencimiento: iso(10) },
  ],
